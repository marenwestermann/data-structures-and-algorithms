...
public class FindMergePointOfTwoLists {
	...
	static int findMergeNode(SinglyLinkedListNode head1, SinglyLinkedListNode head2) {
		/* Implementation: walk through first linked list and store memory addresses
		 * of nodes in hashset. Then walk through second linked list. When we encounter
		 * a previously seen node (in the hashset) then this marks the merge point.
		 */

		HashSet<SinglyLinkedListNode> hs = new HashSet<SinglyLinkedListNode>();

		// walk through linked list 1
		while (head1 != null) {
			hs.add(head1);
			head1 = head1.next;
		}

		// walk through linked list 2
		while (true) {
